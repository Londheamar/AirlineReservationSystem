...
<body>
	...
	<center><div class="meet" style="background: skyblue;box-shadow: 0 0 5px skyblue,
						0 0 10px skyblue,
						0 0 20px skyblue,
						0 0 20px skyblue; width: 20%;padding: 0; top: 0;"><h3 style="font-family: cursive;font-size: 25px; color: white;">...Meet Our Team...</h3></div></center>
	<div class="Contacts">
		<div class="adds">
			<img src="bg/me.jpg">
			<p><i class="far fa-address-book"></i><b> collegekatta.in</b><br><i class="fas fa-envelope-open"></i> collegekatta.info@gmail.com</br><i class="fas fa-mobile-alt"></i> 9595376524</br>your location,</br> Maharashtra-431005</p>
		</div>
	</div>
<br clear="all">
	<div class="feed">
