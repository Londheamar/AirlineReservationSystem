...
<div class="footer contact-us" id="footer">
		...
		<div class="contact1">
			<p>
				<span>collegekatta.in</span><br>
				<span>Mobile Number : 9595376524</span><br>
				<span>Email : <a href="Mailto:collegekatta.info@gmail.com">collegekatta.info@gmail.com</a></span>
			</p>
			<a id="fa-hand" href="" title="See Link" style="color: red;"><i class="fa fa-hand-o-right" aria-hidden="true"></i></a>
    		<a id="fa-facebook" href="https://www.facebook.com/londheamar143" title="Facebook" style="color: #3b5998;"><i class="fab fa-facebook-square" aria-hidden="true"></i></a>
    		<a id="fa-insta" href="https://www.instagram.com/londheamar1434/?hl=en" title="Instagram" style="color: #FE0883;"><i class="fab fa-instagram" aria-hidden="true"></i></a>
    		<a id="fa-tele" href="https://t.me/londheamar143" title="Telegram" style="color:  #0088cc;"><i class="fab fa-telegram" aria-hidden="true"></i></a>
    		<a id="fa-linkin" href="https://www.linkedin.com/in/amar-londhe-17a41612b/" title="Linkedin" style="color: #0e76a8;"><i class="fab fa-linkedin-square" aria-hidden="true"></i></a>
		</div>
		
		<br clear="all">
		<div class="foot">
			<h1 style="font-family: cursive;">© E-Reservation System... All Rights Reserved</h1>
		</div>
	</div>
</div>
