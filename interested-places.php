...
<div class="bodyy">
	<div class="flight-opt-cont" style="margin-top: 40px;">
		...
		<div class="flight-opt">
			...
			<div class="fl-a"><h1>Mumbai FLIGHTS</h1> <p style="font-size:15px;font-family: roboto; margin-left: 5px;margin-top: -15px;">Via :- <a href="result.php<?php echo"?flight=".$mumbai; ?> ">Aurangabad, Hydrabad, Pune</a></p></div>
		</div>
		<div class="flight-opt">
			<div style="float: left;"><img style="border-radius: 50%;" src="bg/Goa.jfif"></div>
			<div class="fl-a"><h1>Goa FLIGHTS</h1> <p style="font-size:15px;font-family: roboto; margin-left: 5px;margin-top: -15px;">Via :- <a href="result.php<?php echo"?flight=".$goa; ?> ">Bengaluru, Hydrabad, Pune</a></p></div>
		</div><br clear="all">
	</div>
	<div class="flight-opt-cont">
		...
		<div class="flight-opt">
			<div style="float: left;"><img style="border-radius: 50%;" src="bg/kolkatta.jfif"></div>
			<div class="fl-a"><h1>Kolkatta FLIGHTS</h1> <p style="font-size:15px;font-family: roboto; margin-left: 5px;margin-top: -15px;">Via :- <a href="result.php<?php echo"?flight=".$kolkatta; ?> ">Aurangabad, Hydrabad, Pune</a></p></div>
		</div>
		<div class="flight-opt">
			<div style="float: left;"><img style="border-radius: 50%;" src="bg/hydrabad.png"></div>
			<div class="fl-a"><h1>Hydrabad FLIGHTS</h1> <p style="font-size:15px;font-family: roboto; margin-left: 5px;margin-top: -15px;">Via :- <a href="result.php<?php echo"?flight=".$hydrabad; ?> ">Bengaluru, Hydrabad, Pune</a></p></div>
		</div><br clear="all">
	</div>
	<div class="flight-opt-cont">
		<div class="flight-opt">
